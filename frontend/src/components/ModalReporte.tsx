...
import type { MessageState, ReportForm } from "../types";

function detectarRiesgoAutomatico(form: ReportForm): string {
  let score = 0;
...
function ModalReporte({ onClose, onSuccess }: ModalReporteProps) {
