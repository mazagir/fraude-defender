...
interface AuthModalProps {
  ...
  onRegister: (nombre: string, email: string, password: string) => void;
  onGuest: () => void;
  error: string;
  loading: boolean;
}

export default function AuthModal({ mode, setMode, onClose, onLogin, onRegister, onGuest, error, loading }: AuthModalProps) {
