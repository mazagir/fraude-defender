...
const riskColors: Record<string, string> = { alto: "#ef4444", medio: "#eab308", bajo: "#00e5b4" };
...
export default function WorldThreatMap(): React.ReactElement {
  const [beacons, setBeacons] = useState<Hotspot[]>(HOTSPOTS);
