...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#05070c] text-slate-100 font-sans relative overflow-hidden flex flex-col md:flex-row select-none">
      ...
      <Sidebar token={token} user={user} activeTab={activeTab} setActiveTab={(tab: string) => { setActiveTab(tab); setScanResult(null); setScanInput(""); }} isSidebarOpen={isSidebarOpen} setIsSidebarOpen={setIsSidebarOpen} isDeveloperMode={isDeveloperMode} setIsDeveloperMode={setIsDeveloperMode} onLogout={handleLogout} onLoginClick={() => setAuthMode("login")} />
